...
from hotel_app.views import AdminViewSet, RoomViewSet, ClientViewSet, InhabitationViewSet, CleanerViewSet, \
    CleaningViewSet, RoomFloorFilterView, RoomNumbersFilterView, RoomFloorRoomTypeFilterView, UploadAvatarClient, \
    UploadFiles
...
router.register(r'upload-client-avatar', UploadAvatarClient)
